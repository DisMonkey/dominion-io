...
import { combatMoraleModifiers } from "../game/MoraleSystem";
import { terrainProfile } from "../game/TerrainSystem";
...
export class DefaultConfig implements Config {
  ...
  unitInfo(type: UnitType): UnitInfo {
    ...
    switch (type) {
      case UnitType.Infantry:
        info = {
          cost: this.costWrapper(() => 50_000, UnitType.Infantry),
          maxHealth: 100,
          damage: 12,
          attackPower: 10,
          defenseModifier: 1,
      ...
      case UnitType.Tank:
        info = {
          cost: this.costWrapper(() => 150_000, UnitType.Tank),
          maxHealth: 300,
          damage: 38,
          attackPower: 34,
          defenseModifier: 1.8,
      ...
      case UnitType.Artillery:
        info = {
          cost: this.costWrapper(() => 125_000, UnitType.Artillery),
          maxHealth: 140,
          damage: 55,
          attackPower: 46,
      ...
      case UnitType.Scout:
        info = {
          cost: this.costWrapper(() => 75_000, UnitType.Scout),
          maxHealth: 70,
          damage: 8,
          attackPower: 6,
          defenseModifier: 0.8,
      ...
      case UnitType.Sniper:
        info = {
          cost: this.costWrapper(() => 100_000, UnitType.Sniper),
          maxHealth: 65,
          damage: 80,
          attackPower: 65,
      ...
      case UnitType.Medic:
        info = {
          cost: this.costWrapper(() => 90_000, UnitType.Medic),
          maxHealth: 90,
          damage: 4,
          attackPower: 2,
          defenseModifier: 0.9,
      ...
      case UnitType.Engineer:
        info = {
          cost: this.costWrapper(() => 120_000, UnitType.Engineer),
          maxHealth: 110,
          damage: 9,
          attackPower: 8,
          defenseModifier: 1.1,
  ...
  attackLogic(
    ...
    const strategicTerrain = terrainProfile(gm, tileToConquer);
    mag *= strategicTerrain.defenseMultiplier;
    speed *= strategicTerrain.assaultSpeedMultiplier;
    const morale = combatMoraleModifiers(gm, attacker, defender, tileToConquer);
    mag *= morale.attackerLossMultiplier;
    speed *= morale.speedMultiplier;
