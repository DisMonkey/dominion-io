# Contributing to Dominion.io

First off, thank you for considering contributing to Dominion.io! It's people like you that make Dominion.io such a great game.
...
- **Game**: [https://dominion.io/](https://dominion.io/)
- **Discord**: [Join the Development Discord](https://discord.gg/K9zernJB5z)
- **Translations**: [Crowdin Project](https://crowdin.com/project/dominion-mls)
- **Issues**: [GitHub Issues](https://github.com/dominion-io/dominion-io/issues)
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/dominion-io.git
   cd dominion-io
   ```
...
- **Full Development Mode** (Client + Server):
  ...
  This starts the Vite dev server and the game server, and opens your browser.
...
We use Crowdin for translations. If you want to help translate Dominion.io:

1. Join the [Translation Discord](https://discord.gg/3zZzacjWFr).
2. Visit our [Crowdin Project](https://crowdin.com/project/dominion-mls).
