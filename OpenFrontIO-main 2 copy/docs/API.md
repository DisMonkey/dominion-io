...
```
GET https://api.dominion.io/public/games
```
...
```bash
curl "https://api.dominion.io/public/games?start=2025-10-25T00:00:00Z&end=2025-10-26T23:59:59Z&type=Public&mode=Team&rankedType=unranked&limit=10&offset=5"
```
...
```
GET https://api.dominion.io/public/game/:gameId
```
...
```bash
# Full game data
curl "https://api.dominion.io/public/game/ABSgwin6"

# Without turn data
curl "https://api.dominion.io/public/game/ABSgwin6?turns=false"
```
...
```
GET https://api.dominion.io/public/player/:playerId
```

**Example:**

```bash
curl "https://api.dominion.io/public/player/HabCsQYR"
```
...
```
GET https://api.dominion.io/public/player/:playerId/sessions
```

**Example:**

```bash
curl "https://api.dominion.io/public/player/HabCsQYR/sessions"
```
...
```
GET https://api.dominion.io/public/clans/leaderboard
```
...
```
GET https://dominion.io/public/clan/:clanTag
```
...
```bash
curl https://api.dominion.io/public/clan/UN?start=2025-11-15T00:00:00Z &
...
```
GET https://api.dominion.io/public/clan/:clanTag/sessions
```
...
```bash
curl "https://api.dominion.io/public/clan/UN/sessions?start=2025-11-15T00:00:00Z&end=2025-11-18T23:59:59Z&limit=10&page=1"
```
