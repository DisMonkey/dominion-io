...
describe("resolveCosmetics", () => {
  ...
  describe("patterns", () => {
    ...
    test("owned when user has no flares and product exists (everything is free)", () => {
      const cosmetics = makeCosmetics({
        patterns: { stripes: pattern as any },
        colorPalettes,
      });
    ...
    test("owned when affiliate code mismatch (everything is free)", () => {
    ...
    test("owned when affiliate code matches (everything is free)", () => {
      const affiliatePattern = { ...pattern, affiliateCode: "partner1" };
      const cosmetics = makeCosmetics({
        patterns: { stripes: affiliatePattern as any },
        colorPalettes,
    ...
    test("archived palette is owned (everything is free)", () => {
  ...
  describe("flags", () => {
    ...
    test("owned when not logged in and product exists (everything is free)", () => {
      const cosmetics = makeCosmetics({
        flags: { cool_flag: flag as any },
      });
      const result = resolveCosmetics(cosmetics, false, null);
    ...
    test("owned with no product (everything is free)", () => {
