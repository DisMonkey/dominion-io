import { V as Texture, W as TextureSource, Z as deprecation, at as Point, ot as DEG_TO_RAD, p as GpuProgram, x as GlProgram, z as Color } from "./Geometry-wn3lA2k3.js";
import { Nn as BlurFilter, Pn as BlurFilterPass, Vn as AlphaFilter } from "./lib-BRTyuQYs.js";
import { U as ObservablePoint, g as TexturePool, t as Filter } from "./Filter-lQk3p6CJ.js";
import { t as ImageSource } from "./ImageSource-Co2UTbvR.js";
import { o as ViewSystem } from "./RenderTargetSystem-BYaSrH0r.js";
//#region node_modules/pixi-filters/lib/defaults/default2.mjs
var vertex = "in vec2 aPosition;\nout vec2 vTextureCoord;\n\nuniform vec4 uInputSize;\nuniform vec4 uOutputFrame;\nuniform vec4 uOutputTexture;\n\nvec4 filterVertexPosition( void )\n{\n    vec2 position = aPosition * uOutputFrame.zw + uOutputFrame.xy;\n    \n    position.x = position.x * (2.0 / uOutputTexture.x) - 1.0;\n    position.y = position.y * (2.0*uOutputTexture.z / uOutputTexture.y) - uOutputTexture.z;\n\n    return vec4(position, 0.0, 1.0);\n}\n\nvec2 filterTextureCoord( void )\n{\n    return aPosition * (uOutputFrame.zw * uInputSize.zw);\n}\n\nvoid main(void)\n{\n    gl_Position = filterVertexPosition();\n    vTextureCoord = filterTextureCoord();\n}\n";
//#endregion
//#region node_modules/pixi-filters/lib/defaults/default.mjs
...
//#endregion
//#region node_modules/pixi-filters/lib/adjustment/adjustment.mjs
var fragment$36 = "in vec2 vTextureCoord;\nout vec4 finalColor;\n\nuniform sampler2D uTexture;\nuniform float uGamma;\nuniform float uContrast;\nuniform float uSaturation;\nuniform float uBrightness;\nuniform vec4 uColor;\n\nvoid main()\n{\n    vec4 c = texture(uTexture, vTextureCoord);\n\n    if (c.a > 0.0) {\n        c.rgb /= c.a;\n\n        vec3 rgb = pow(c.rgb, vec3(1. / uGamma));\n        rgb = mix(vec3(.5), mix(vec3(dot(vec3(.2125, .7154, .0721), rgb)), rgb, uSaturation), uContrast);\n        rgb.r *= uColor.r;\n        rgb.g *= uColor.g;\n        rgb.b *= uColor.b;\n        c.rgb = rgb * uBrightness;\n\n        c.rgb *= c.a;\n    }\n\n    finalColor = c * uColor.a;\n}\n";
//#endregion
//#region node_modules/pixi-filters/lib/adjustment/adjustment2.mjs
var source$35 = "struct AdjustmentUniforms {\n  uGamma: f32,\n  uContrast: f32,\n  uSaturation: f32,\n  uBrightness: f32,\n  uColor: vec4<f32>,\n};\n\n@group(0) @binding(1) var uTexture: texture_2d<f32>; \n@group(0) @binding(2) var uSampler: sampler;\n@group(1) @binding(0) var<uniform> adjustmentUniforms : AdjustmentUniforms;\n\n@fragment\nfn mainFragment(\n  @location(0) uv: vec2<f32>,\n  @builtin(position) position: vec4<f32>\n) -> @location(0) vec4<f32> {\n  var sample = textureSample(uTexture, uSampler, uv);\n  let color = adjustmentUniforms.uColor;\n\n  if (sample.a > 0.0) \n  {\n    sample = vec4<f32>(sample.rgb / sample.a, sample.a);\n    var rgb: vec3<f32> = pow(sample.rgb, vec3<f32>(1. / adjustmentUniforms.uGamma));\n    rgb = mix(vec3<f32>(.5), mix(vec3<f32>(dot(vec3<f32>(.2125, .7154, .0721), rgb)), rgb, adjustmentUniforms.uSaturation), adjustmentUniforms.uContrast);\n    rgb.r *= color.r;\n    rgb.g *= color.g;\n    rgb.b *= color.b;\n    sample = vec4<f32>(rgb.rgb * adjustmentUniforms.uBrightness, sample.a);\n    sample = vec4<f32>(sample.rgb * sample.a, sample.a);\n  }\n\n  return sample * color.a;\n}";
//#endregion
//#region node_modules/pixi-filters/lib/adjustment/AdjustmentFilter.mjs
var __defProp$35 = Object.defineProperty;
var __defNormalProp$35 = (obj, key, value) => key in obj ? __defProp$35(obj, key, {
	enumerable: true,
	configurable: true,
	writable: true,
	value
}) : obj[key] = value;
var __publicField$35 = (obj, key, value) => {
	__defNormalProp$35(obj, typeof key !== "symbol" ? key + "" : key, value);
	return value;
};
var _AdjustmentFilter = class _AdjustmentFilter extends Filter {
	/**
	* @param options - The options of the adjustment filter.
	*/
	constructor(options) {
		options = {
			..._AdjustmentFilter.DEFAULT_OPTIONS,
			...options
		};
		...
		__publicField$35(this, "uniforms");
...
__publicField$35(_AdjustmentFilter, "DEFAULT_OPTIONS", {
	gamma: 1,
	contrast: 1,
	saturation: 1,
	brightness: 1,
...
//#endregion
//#region node_modules/pixi-filters/lib/kawase-blur/kawase-blur.mjs
var fragment$35 = "\nin vec2 vTextureCoord;\nout vec4 finalColor;\n\nuniform sampler2D uTexture;\nuniform vec2 uOffset;\n\nvoid main(void)\n{\n    vec4 color = vec4(0.0);\n\n    // Sample top left pixel\n    color += texture(uTexture, vec2(vTextureCoord.x - uOffset.x, vTextureCoord.y + uOffset.y));\n\n    // Sample top right pixel\n    color += texture(uTexture, vec2(vTextureCoord.x + uOffset.x, vTextureCoord.y + uOffset.y));\n\n    // Sample bottom right pixel\n    color += texture(uTexture, vec2(vTextureCoord.x + uOffset.x, vTextureCoord.y - uOffset.y));\n\n    // Sample bottom left pixel\n    color += texture(uTexture, vec2(vTextureCoord.x - uOffset.x, vTextureCoord.y - uOffset.y));\n\n    // Average\n    color *= 0.25;\n\n    finalColor = color;\n}";
//#endregion
//#region node_modules/pixi-filters/lib/kawase-blur/kawase-blur2.mjs
var source$34 = "struct KawaseBlurUniforms {\n  uOffset:vec2<f32>,\n};\n\n@group(0) @binding(1) var uTexture: texture_2d<f32>; \n@group(0) @binding(2) var uSampler: sampler;\n@group(1) @binding(0) var<uniform> kawaseBlurUniforms : KawaseBlurUniforms;\n\n@fragment\nfn mainFragment(\n  @builtin(position) position: vec4<f32>,\n  @location(0) uv : vec2<f32>\n) -> @location(0) vec4<f32> {\n  let uOffset = kawaseBlurUniforms.uOffset;\n  var color: vec4<f32> = vec4<f32>(0.0);\n\n  // Sample top left pixel\n  color += textureSample(uTexture, uSampler, vec2<f32>(uv.x - uOffset.x, uv.y + uOffset.y));\n  // Sample top right pixel\n  color += textureSample(uTexture, uSampler, vec2<f32>(uv.x + uOffset.x, uv.y + uOffset.y));\n  // Sample bottom right pixel\n  color += textureSample(uTexture, uSampler, vec2<f32>(uv.x + uOffset.x, uv.y - uOffset.y));\n  // Sample bottom left pixel\n  color += textureSample(uTexture, uSampler, vec2<f32>(uv.x - uOffset.x, uv.y - uOffset.y));\n  // Average\n  color *= 0.25;\n\n  return color;\n}";
//#endregion
//#region node_modules/pixi-filters/lib/kawase-blur/kawase-blur-clamp.mjs
var fragmentClamp = "\nprecision highp float;\nin vec2 vTextureCoord;\nout vec4 finalColor;\n\nuniform sampler2D uTexture;\nuniform vec2 uOffset;\n\nuniform vec4 uInputClamp;\n\nvoid main(void)\n{\n    vec4 color = vec4(0.0);\n\n    // Sample top left pixel\n    color += texture(uTexture, clamp(vec2(vTextureCoord.x - uOffset.x, vTextureCoord.y + uOffset.y), uInputClamp.xy, uInputClamp.zw));\n\n    // Sample top right pixel\n    color += texture(uTexture, clamp(vec2(vTextureCoord.x + uOffset.x, vTextureCoord.y + uOffset.y), uInputClamp.xy, uInputClamp.zw));\n\n    // Sample bottom right pixel\n    color += texture(uTexture, clamp(vec2(vTextureCoord.x + uOffset.x, vTextureCoord.y - uOffset.y), uInputClamp.xy, uInputClamp.zw));\n\n    // Sample bottom left pixel\n    color += texture(uTexture, clamp(vec2(vTextureCoord.x - uOffset.x, vTextureCoord.y - uOffset.y), uInputClamp.xy, uInputClamp.zw));\n\n    // Average\n    color *= 0.25;\n\n    finalColor = color;\n}\n";
//#endregion
//#region node_modules/pixi-filters/lib/kawase-blur/kawase-blur-clamp2.mjs
var sourceClamp = "struct KawaseBlurUniforms {\n  uOffset:vec2<f32>,\n};\n\nstruct GlobalFilterUniforms {\n  uInputSize:vec4<f32>,\n  uInputPixel:vec4<f32>,\n  uInputClamp:vec4<f32>,\n  uOutputFrame:vec4<f32>,\n  uGlobalFrame:vec4<f32>,\n  uOutputTexture:vec4<f32>,\n};\n\n@group(0) @binding(0) var<uniform> gfu: GlobalFilterUniforms;\n\n@group(0) @binding(1) var uTexture: texture_2d<f32>; \n@group(0) @binding(2) var uSampler: sampler;\n@group(1) @binding(0) var<uniform> kawaseBlurUniforms : KawaseBlurUniforms;\n\n@fragment\nfn mainFragment(\n  @builtin(position) position: vec4<f32>,\n  @location(0) uv : vec2<f32>\n) -> @location(0) vec4<f32> {\n  let uOffset = kawaseBlurUniforms.uOffset;\n  var color: vec4<f32> = vec4(0.0);\n\n  // Sample top left pixel\n  color += textureSample(uTexture, uSampler, clamp(vec2<f32>(uv.x - uOffset.x, uv.y + uOffset.y), gfu.uInputClamp.xy, gfu.uInputClamp.zw));\n  // Sample top right pixel\n  color += textureSample(uTexture, uSampler, clamp(vec2<f32>(uv.x + uOffset.x, uv.y + uOffset.y), gfu.uInputClamp.xy, gfu.uInputClamp.zw));\n  // Sample bottom right pixel\n  color += textureSample(uTexture, uSampler, clamp(vec2<f32>(uv.x + uOffset.x, uv.y - uOffset.y), gfu.uInputClamp.xy, gfu.uInputClamp.zw));\n  // Sample bottom left pixel\n  color += textureSample(uTexture, uSampler, clamp(vec2<f32>(uv.x - uOffset.x, uv.y - uOffset.y), gfu.uInputClamp.xy, gfu.uInputClamp.zw));\n  // Average\n  color *= 0.25;\n    \n  return color;\n}";
//#endregion
//#region node_modules/pixi-filters/lib/kawase-blur/KawaseBlurFilter.mjs
...
var __publicField$34 = (obj, key, value) => {
	__defNormalProp$34(obj, typeof key !== "symbol" ? key + "" : key, value);
	return value;
};
var _KawaseBlurFilter = class _KawaseBlurFilter extends Filter {
	/** @ignore */
	constructor(...args) {
		let options = args[0] ?? {};
		...
		options = {
			..._KawaseBlurFilter.DEFAULT_OPTIONS,
			...options
		};
		const gpuProgram = GpuProgram.from({
			vertex: {
			...
			fragment: {
				source: options?.clamp ? sourceClamp : source$34,
				entryPoint: "mainFragment"
			}
		});
		const glProgram = GlProgram.from({
			vertex,
			fragment: options?.clamp ? fragmentClamp : fragment$35,
		...
		__publicField$34(this, "uniforms");
		__publicField$34(this, "_pixelSize", {
			x: 0,
			y: 0
		});
		__publicField$34(this, "_clamp");
		__publicField$34(this, "_kernels", []);
		__publicField$34(this, "_blur");
		__publicField$34(this, "_quality");
		this.uniforms = this.resources.kawaseBlurUniforms.uniforms;
		this.pixelSize = options.pixelSize ?? {
			x: 1,
			y: 1
		};
		if (Array.isArray(options.strength)) this.kernels = options.strength;
	...
	*/
	...
	_updatePadding() {
		this.padding = Math.ceil(this._kernels.reduce((acc, v) => acc + v + .5, 0));
	}
...
/** Default values for options. */
__publicField$34(_KawaseBlurFilter, "DEFAULT_OPTIONS", {
	strength: 4,
	quality: 3,
	clamp: false,
	pixelSize: {
...
//#endregion
//#region node_modules/pixi-filters/lib/advanced-bloom/advanced-bloom.mjs
var fragment$34 = "in vec2 vTextureCoord;\nout vec4 finalColor;\n\nuniform sampler2D uTexture;\nuniform sampler2D uMapTexture;\nuniform float uBloomScale;\nuniform float uBrightness;\n\nvoid main() {\n    vec4 color = texture(uTexture, vTextureCoord);\n    color.rgb *= uBrightness;\n    vec4 bloomColor = vec4(texture(uMapTexture, vTextureCoord).rgb, 0.0);\n    bloomColor.rgb *= uBloomScale;\n    finalColor = color + bloomColor;\n}\n";
//#endregion
//#region node_modules/pixi-filters/lib/advanced-bloom/advanced-bloom2.mjs
var source$33 = "struct AdvancedBloomUniforms {\n  uBloomScale: f32,\n  uBrightness: f32,\n};\n\n@group(0) @binding(1) var uTexture: texture_2d<f32>; \n@group(0) @binding(2) var uSampler: sampler;\n@group(1) @binding(0) var<uniform> advancedBloomUniforms : AdvancedBloomUniforms;\n@group(1) @binding(1) var uMapTexture: texture_2d<f32>;\n\n@fragment\nfn mainFragment(\n  @builtin(position) position: vec4<f32>,\n  @location(0) uv : vec2<f32>\n) -> @location(0) vec4<f32> {\n  var color = textureSample(uTexture, uSampler, uv);\n  color = vec4<f32>(color.rgb * advancedBloomUniforms.uBrightness, color.a);\n\n  var bloomColor = vec4<f32>(textureSample(uMapTexture, uSampler, uv).rgb, 0.0);\n  bloomColor = vec4<f32>(bloomColor.rgb * advancedBloomUniforms.uBloomScale, bloomColor.a);\n  \n  return color + bloomColor;\n}\n";
//#endregion
//#region node_modules/pixi-filters/lib/advanced-bloom/extract-brightness.mjs
var fragment$33 = "\nin vec2 vTextureCoord;\nout vec4 finalColor;\n\nuniform sampler2D uTexture;\nuniform float uThreshold;\n\nvoid main() {\n    vec4 color = texture(uTexture, vTextureCoord);\n\n    // A simple & fast algorithm for getting brightness.\n    // It's inaccuracy , but good enought for this feature.\n    float _max = max(max(color.r, color.g), color.b);\n    float _min = min(min(color.r, color.g), color.b);\n    float brightness = (_max + _min) * 0.5;\n\n    if(brightness > uThreshold) {\n        finalColor = color;\n    } else {\n        finalColor = vec4(0.0, 0.0, 0.0, 0.0);\n    }\n}\n";
//#endregion
//#region node_modules/pixi-filters/lib/advanced-bloom/extract-brightness2.mjs
var source$32 = "struct ExtractBrightnessUniforms {\n  uThreshold: f32,\n};\n\n@group(0) @binding(1) var uTexture: texture_2d<f32>; \n@group(0) @binding(2) var uSampler: sampler;\n@group(1) @binding(0) var<uniform> extractBrightnessUniforms : ExtractBrightnessUniforms;\n\n@fragment\nfn mainFragment(\n  @builtin(position) position: vec4<f32>,\n  @location(0) uv : vec2<f32>\n) -> @location(0) vec4<f32> {\n  let color: vec4<f32> = textureSample(uTexture, uSampler, uv);\n\n  // A simple & fast algorithm for getting brightness.\n  // It's inaccurate, but good enough for this feature.\n  let max: f32 = max(max(color.r, color.g), color.b);\n  let min: f32 = min(min(color.r, color.g), color.b);\n  let brightness: f32 = (max + min) * 0.5;\n\n  return select(vec4<f32>(0.), color, brightness > extractBrightnessUniforms.uThreshold);\n}\n";
//#endregion
//#region node_modules/pixi-filters/lib/advanced-bloom/ExtractBrightnessFilter.mjs
...
var __publicField$33 = (obj, key, value) => {
	__defNormalProp$33(obj, typeof key !== "symbol" ? key + "" : key, value);
	return value;
};
var _ExtractBrightnessFilter = class _ExtractBrightnessFilter extends Filter {
	constructor(options) {
		options = {
			..._ExtractBrightnessFilter.DEFAULT_OPTIONS,
			...options
		};
		const gpuProgram = GpuProgram.from({
			vertex: {
		...
		super({
			gpuProgram,
			glProgram,
			resources: { extractBrightnessUniforms: { uThreshold: {
				value: options.threshold,
				type: "f32"
			} } }
		});
		__publicField$33(this, "uniforms");
...
/** Default values for options. */
__publicField$33(_ExtractBrightnessFilter, "DEFAULT_OPTIONS", { threshold: .5 });
var ExtractBrightnessFilter = _ExtractBrightnessFilter;
//#endregion
//#region node_modules/pixi-filters/lib/advanced-bloom/AdvancedBloomFilter.mjs
...
var __publicField$32 = (obj, key, value) => {
	__defNormalProp$32(obj, typeof key !== "symbol" ? key + "" : key, value);
	return value;
};
var _AdvancedBloomFilter = class _AdvancedBloomFilter extends Filter {
	/**
	* @param options - Options for the AdvancedBloomFilter constructor.
	*/
	constructor(options) {
		options = {
			..._AdvancedBloomFilter.DEFAULT_OPTIONS,
			...options
		};
		const gpuProgram = GpuProgram.from({
			vertex: {
		...
		__publicField$32(this, "uniforms");
		/** To adjust the strength of the bloom. Higher values is more intense brightness. */
		__publicField$32(this, "bloomScale", 1);
		/** The brightness, lower value is more subtle brightness, higher value is blown-out. */
		__publicField$32(this, "brightness", 1);
		__publicField$32(this, "_extractFilter");
		__publicField$32(this, "_blurFilter");
		this.uniforms = this.resources.advancedBloomUniforms.uniforms;
		this._extractFilter = new ExtractBrightnessFilter({ threshold: options.threshold });
...
/** Default values for options. */
__publicField$32(_AdvancedBloomFilter, "DEFAULT_OPTIONS", {
	threshold: .5,
	bloomScale: 1,
	brightness: 1,
	blur: 8,
...
var __publicField$31 = (obj, key, value) => {
	__defNormalProp$31(obj, typeof key !== "symbol" ? key + "" : key, value);
	return value;
};
var _AsciiFilter = class _AsciiFilter extends Filter {
	/** @ignore */
	constructor(...args) {
		let options = args[0] ?? {};
		...
		__publicField$31(this, "uniforms");
		__publicField$31(this, "_color");
...
/** Default values for options. */
__publicField$31(_AsciiFilter, "DEFAULT_OPTIONS", {
	size: 8,
	color: 16777215,
	replaceColor: false
});
...
//#endregion
//#region node_modules/pixi-filters/lib/backdrop-blur/backdrop-blur-blend2.mjs
var fragment$31 = "precision highp float;\nin vec2 vTextureCoord;\nout vec4 finalColor;\n\nuniform sampler2D uTexture;\nuniform sampler2D uBackground;\n\nvoid main(void){\n    vec4 front = texture(uTexture, vTextureCoord);\n    vec4 back = texture(uBackground, vTextureCoord);\n\n    if (front.a == 0.0) {\n        discard;\n    }\n    \n    vec3 color = mix(back.rgb, front.rgb / front.a, front.a);\n\n    finalColor = vec4(color, 1.0);\n}";
//#endregion
//#region node_modules/pixi-filters/lib/backdrop-blur/backdrop-blur-blend.mjs
...
//#endregion
//#region node_modules/pixi-filters/lib/backdrop-blur/BackdropBlurFilter.mjs
...
var __publicField$30 = (obj, key, value) => {
...
var BackdropBlurFilter = class extends BlurFilter {
	...
	*/
	constructor(options) {
		super(options);
		__publicField$30(this, "_blendPass");
		...
		this._blendPass = new Filter({
			...
			glProgram: GlProgram.from({
				vertex,
				fragment: fragment$31,
				name: "drop-shadow-filter"
			}),
			resources: { uBackground: Texture.EMPTY }
		});
	}
	/**
	* Override existing apply method in `Filter`
...
var __publicField$29 = (obj, key, value) => {
	__defNormalProp$29(obj, typeof key !== "symbol" ? key + "" : key, value);
	return value;
};
var _BevelFilter = class _BevelFilter extends Filter {
	/**
	* @param options - Options for the BevelFilter constructor.
	*/
	constructor(options) {
		options = {
			..._BevelFilter.DEFAULT_OPTIONS,
			...options
		};
		const gpuProgram = GpuProgram.from({
			vertex: {
		...
		__publicField$29(this, "uniforms");
		__publicField$29(this, "_thickness");
		__publicField$29(this, "_rotation");
		__publicField$29(this, "_lightColor");
		__publicField$29(this, "_shadowColor");
...
/** Default values for options. */
__publicField$29(_BevelFilter, "DEFAULT_OPTIONS", {
	rotation: 45,
	thickness: 2,
	lightColor: 16777215,
	lightAlpha: .7,
...
//#endregion
//#region node_modules/pixi-filters/lib/bloom/BloomFilter.mjs
...
var __publicField$28 = (obj, key, value) => {
	__defNormalProp$28(obj, typeof key !== "symbol" ? key + "" : key, value);
	return value;
};
var _BloomFilter = class _BloomFilter extends AlphaFilter {
	/** @ignore */
	constructor(...args) {
		let options = args[0] ?? {};
		if (typeof options === "number" || Array.isArray(options) || "x" in options && "y" in options) {
			...
			if (Array.isArray(strength)) strength = {
				x: strength[0],
				y: strength[1]
			};
			options = { strength };
			if (args[1] !== void 0) options.quality = args[1];
			if (args[2] !== void 0) options.resolution = args[2];
			if (args[3] !== void 0) options.kernelSize = args[3];
		}
		options = {
			..._BloomFilter.DEFAULT_OPTIONS,
			...options
		};
		super();
		__publicField$28(this, "_blurXFilter");
		__publicField$28(this, "_blurYFilter");
		__publicField$28(this, "_strength");
		this._strength = {
			x: 2,
			y: 2
		};
		if (options.strength) if (typeof options.strength === "number") {
	...
	*/
	...
	set strength(value) {
		this._strength = typeof value === "number" ? {
			x: value,
			y: value
		} : value;
...
/** Default values for options. */
__publicField$28(_BloomFilter, "DEFAULT_OPTIONS", {
	strength: {
		x: 2,
		y: 2
	},
...
//#endregion
//#region node_modules/pixi-filters/lib/bulge-pinch/bulge-pinch2.mjs
var fragment$29 = "precision highp float;\nin vec2 vTextureCoord;\nout vec4 finalColor;\n\nuniform sampler2D uTexture;\nuniform vec2 uDimensions;\nuniform vec2 uCenter;\nuniform float uRadius;\nuniform float uStrength;\n\nuniform vec4 uInputSize;\nuniform vec4 uInputClamp;\n\nvoid main()\n{\n    vec2 coord = vTextureCoord * uInputSize.xy;\n    coord -= uCenter * uDimensions.xy;\n    float distance = length(coord);\n\n    if (distance < uRadius) {\n        float percent = distance / uRadius;\n        if (uStrength > 0.0) {\n            coord *= mix(1.0, smoothstep(0.0, uRadius / distance, percent), uStrength * 0.75);\n        } else {\n            coord *= mix(1.0, pow(percent, 1.0 + uStrength * 0.75) * uRadius / distance, 1.0 - percent);\n        }\n    }\n\n    coord += uCenter * uDimensions.xy;\n    coord /= uInputSize.xy;\n    vec2 clampedCoord = clamp(coord, uInputClamp.xy, uInputClamp.zw);\n    vec4 color = texture(uTexture, clampedCoord);\n\n    if (coord != clampedCoord) {\n        color *= max(0.0, 1.0 - length(coord - clampedCoord));\n    }\n\n    finalColor = color;\n}\n";
//#endregion
//#region node_modules/pixi-filters/lib/bulge-pinch/bulge-pinch.mjs
var source$29 = "struct BulgePinchUniforms {\n  uDimensions: vec2<f32>,\n  uCenter: vec2<f32>,\n  uRadius: f32,\n  uStrength: f32,\n};\n\nstruct GlobalFilterUniforms {\n  uInputSize:vec4<f32>,\n  uInputPixel:vec4<f32>,\n  uInputClamp:vec4<f32>,\n  uOutputFrame:vec4<f32>,\n  uGlobalFrame:vec4<f32>,\n  uOutputTexture:vec4<f32>,\n};\n\n@group(0) @binding(0) var<uniform> gfu: GlobalFilterUniforms;\n\n@group(0) @binding(1) var uTexture: texture_2d<f32>; \n@group(0) @binding(2) var uSampler: sampler;\n@group(1) @binding(0) var<uniform> bulgePinchUniforms : BulgePinchUniforms;\n\n@fragment\nfn mainFragment(\n  @builtin(position) position: vec4<f32>,\n  @location(0) uv : vec2<f32>\n) -> @location(0) vec4<f32> {\n  let dimensions: vec2<f32> = bulgePinchUniforms.uDimensions;\n  let center: vec2<f32> = bulgePinchUniforms.uCenter;\n  let radius: f32 = bulgePinchUniforms.uRadius;\n  let strength: f32 = bulgePinchUniforms.uStrength;\n  var coord: vec2<f32> = (uv * gfu.uInputSize.xy) - center * dimensions.xy;\n\n  let distance: f32 = length(coord);\n\n  if (distance < radius) {\n      let percent: f32 = distance / radius;\n      if (strength > 0.0) {\n          coord *= mix(1.0, smoothstep(0.0, radius / distance, percent), strength * 0.75);\n      } else {\n          coord *= mix(1.0, pow(percent, 1.0 + strength * 0.75) * radius / distance, 1.0 - percent);\n      }\n  }\n    coord += (center * dimensions.xy);\n    coord /= gfu.uInputSize.xy;\n\n    let clampedCoord: vec2<f32> = clamp(coord, gfu.uInputClamp.xy, gfu.uInputClamp.zw);\n    var color: vec4<f32> = textureSample(uTexture, uSampler, clampedCoord);\n    if (coord.x != clampedCoord.x && coord.y != clampedCoord.y) {\n        color *= max(0.0, 1.0 - length(coord - clampedCoord));\n    }\n\n    return color;\n}\n\nfn compareVec2(x: vec2<f32>, y: vec2<f32>) -> bool\n{\n  if (x.x == y.x && x.y == y.y)\n  {\n    return true;\n  }\n\n  return false;\n}";
//#endregion
//#region node_modules/pixi-filters/lib/bulge-pinch/BulgePinchFilter.mjs
...
var __publicField$27 = (obj, key, value) => {
	__defNormalProp$27(obj, typeof key !== "symbol" ? key + "" : key, value);
	return value;
};
var _BulgePinchFilter = class _BulgePinchFilter extends Filter {
	/**
	* @param options - Options for the BulgePinchFilter constructor.
	*/
	constructor(options) {
		options = {
			..._BulgePinchFilter.DEFAULT_OPTIONS,
			...options
		};
		const gpuProgram = GpuProgram.from({
			vertex: {
		...
		__publicField$27(this, "uniforms");
...
/** Default values for options. */
__publicField$27(_BulgePinchFilter, "DEFAULT_OPTIONS", {
	center: {
		x: .5,
		y: .5
	},
...
GradientParser.stringify = (function() {
	var visitor = {
		...
		"visit": function(element) {
			if (!element) return "";
			var result = "";
			if (element instanceof Array) return visitor.visit_array(element, result);
			else if (element.type) {
				var nodeVisitor = visitor["visit_" + element.type];
				if (nodeVisitor) return nodeVisitor(element);
				else throw Error("Missing visitor visit_" + element.type);
...
GradientParser.parse = (function() {
	...
	var input = "";
	function error(msg) {
		var err = /* @__PURE__ */ new Error(input + ": " + msg);
		err.source = input;
		throw err;
	}
	function getAST() {
		var ast = matchListDefinitions();
		if (input.length > 0) error("Invalid input not EOF");
		return ast;
	}
	...
	function matchGradient(gradientType, pattern, orientationMatcher) {
		return matchCall(pattern, function(captures) {
			...
			if (orientation) {
				if (!scan(tokens.comma)) error("Missing comma before color stops");
			}
			return {
				type: gradientType,
				orientation,
	...
	function matchListRadialOrientations() {
		...
		if (radialOrientation) {
			...
			if (scan(tokens.comma)) {
				...
				if (radialOrientation) radialOrientations.push(radialOrientation);
				else input = lookaheadCache;
			}
		}
	...
	function matchRadialOrientation() {
		...
		if (radialType) radialType.at = matchAtPosition();
			...
			if (extent) {
				...
				if (positionAt) radialType.at = positionAt;
			} else {
				var defaultPosition = matchPositioning();
				if (defaultPosition) radialType = {
					type: "default-radial",
					at: defaultPosition
				};
			}
	...
	function matchCircle() {
		...
		if (circle) circle.style = matchLength() || matchExtentKeyword();
		return circle;
	}
	function matchEllipse() {
		var ellipse = match("shape", /^(ellipse)/i, 0);
		if (ellipse) ellipse.style = matchDistance() || matchExtentKeyword();
		return ellipse;
	}
	...
	function matchListing(matcher) {
		...
		if (captures) {
			...
			while (scan(tokens.comma)) {
				captures = matcher();
				if (captures) result.push(captures);
				else error("One extra comma");
			}
		}
		return result;
	}
...
//#endregion
//#region node_modules/pixi-filters/lib/color-gradient/CssGradientParser.mjs
function parseCssGradient(cssGradient) {
	const cssGradientNodes = parse(trimCssGradient(cssGradient));
	if (cssGradientNodes.length === 0) throw new Error("Invalid CSS gradient.");
	else if (cssGradientNodes.length !== 1) throw new Error("Unsupported CSS gradient (multiple gradients is not supported).");
	const cssGradientNode = cssGradientNodes[0];
	return {
		type: typeFromCssType(cssGradientNode.type),
		stops: stopsFromCssStops(cssGradientNode.colorStops),
		angle: angleFromCssOrientation(cssGradientNode.orientation)
	};
}
function typeFromCssType(type) {
	...
	if (!(type in supportedTypes)) throw new Error(`Unsupported gradient type "${type}"`);
...
function colorAsStringFromCssStop(stop) {
	switch (stop.type) {
		case "hex": return `#${stop.value}`;
		case "literal": return stop.value;
		default: return `${stop.type}(${stop.value.join(",")})`;
	}
}
function offsetsFromCssColorStops(stops) {
	...
	for (let i = 0; i < stops.length; i++) {
		...
		if (cssStop.type === "literal") {
			if (cssStop.length && "type" in cssStop.length && cssStop.length.type === "%" && "value" in cssStop.length) stopOffset = parseFloat(cssStop.length.value) / 100;
		}
		offsets.push(stopOffset);
	}
	const findNextFixedStop = (fromIndex) => {
		for (let k = fromIndex; k < offsets.length; k++) if (offsets[k] !== dynamicOffset) return {
	...
	for (let i = 0; i < offsets.length; i++) {
		...
		if (offset !== dynamicOffset) prevFixedOffset = offset;
		else if (i === 0) offsets[i] = 0;
		else if (i + 1 === offsets.length) offsets[i] = 1;
		else {
			const nextFixed = findNextFixedStop(i);
			const stepSize = (nextFixed.offset - prevFixedOffset) / (1 + nextFixed.indexDelta);
			for (let s = 0; s <= nextFixed.indexDelta; s++) offsets[i + s] = prevFixedOffset + (s + 1) * stepSize;
...
function fixFloatRounding(value) {
	const maxLength = 6;
	if (value.toString().length > maxLength) return parseFloat(value.toString().substring(0, maxLength));
	return value;
}
function angleFromCssOrientation(orientation) {
	if (typeof orientation === "undefined") return 0;
	if ("type" in orientation && "value" in orientation) switch (orientation.type) {
		case "angular": return parseFloat(orientation.value);
		case "directional": return angleFromDirectionalValue(orientation.value);
	}
	return 0;
}
function angleFromDirectionalValue(value) {
	...
	if (!(value in supportedValues)) throw new Error(`Unsupported directional value "${value}"`);
...
//#endregion
//#region node_modules/pixi-filters/lib/color-gradient/ColorGradientFilter.mjs
...
var __publicField$26 = (obj, key, value) => {
...
var _ColorGradientFilter = class _ColorGradientFilter extends Filter {
	/**
	* @param options - Options for the ColorGradientFilter constructor.
	*/
	constructor(options) {
		if (options && "css" in options) options = {
			...
			..._ColorGradientFilter.defaults,
			...options
		};
		if (!options.stops || options.stops.length < 2) throw new Error("ColorGradientFilter requires at least 2 color stops.");
		const gpuProgram = GpuProgram.from({
			vertex: {
				source: source$28,
				entryPoint: "mainVertex"
		...
		super({
			...
			resources: {
				baseUniforms: {
					...
					uCounts: {
						value: [options.stops.length, options.maxColors],
						type: "vec2<f32>"
					}
				},
				stopsUniforms: {
					uColors: {
						value: new Float32Array(maxStops * 3),
						type: "vec3<f32>",
						size: maxStops
					},
					uStops: {
						value: new Float32Array(maxStops * 4),
						type: "vec4<f32>",
						size: maxStops
					}
				}
		...
		__publicField$26(this, "baseUniforms");
		__publicField$26(this, "stopsUniforms");
		__publicField$26(this, "_stops", []);
...
/** Gradient types */
__publicField$26(_ColorGradientFilter, "LINEAR", 0);
__publicField$26(_ColorGradientFilter, "RADIAL", 1);
__publicField$26(_ColorGradientFilter, "CONIC", 2);
/** Default constructor options */
__publicField$26(_ColorGradientFilter, "defaults", {
...
var __publicField$25 = (obj, key, value) => {
	__defNormalProp$25(obj, typeof key !== "symbol" ? key + "" : key, value);
	return value;
};
var _ColorMapFilter = class _ColorMapFilter extends Filter {
	/** @ignore */
	constructor(...args) {
		let options = args[0] ?? {};
		if (options instanceof Texture || options instanceof TextureSource) {
			...
			if (args[1] !== void 0) options.nearest = args[1];
			if (args[2] !== void 0) options.mix = args[2];
		}
		options = {
			..._ColorMapFilter.DEFAULT_OPTIONS,
			...options
		};
		...
		__publicField$25(this, "uniforms");
		__publicField$25(this, "_size", 0);
		__publicField$25(this, "_sliceSize", 0);
		__publicField$25(this, "_slicePixelSize", 0);
		__publicField$25(this, "_sliceInnerSize", 0);
		__publicField$25(this, "_nearest", false);
		__publicField$25(this, "_scaleMode", "linear");
		__publicField$25(this, "_colorMap");
...
/** Default values for options. */
__publicField$25(_ColorMapFilter, "DEFAULT_OPTIONS", {
...
//#endregion
//#region node_modules/pixi-filters/lib/color-overlay/color-overlay2.mjs
var fragment$26 = "in vec2 vTextureCoord;\nout vec4 finalColor;\n\nuniform sampler2D uTexture;\nuniform vec3 uColor;\nuniform float uAlpha;\n\nvoid main(void) {\n    vec4 c = texture(uTexture, vTextureCoord);\n    finalColor = vec4(mix(c.rgb, uColor * c.a, uAlpha), c.a);\n}";
//#endregion
//#region node_modules/pixi-filters/lib/color-overlay/color-overlay.mjs
var source$26 = "struct ColorOverlayUniforms {\n    uColor: vec3<f32>,\n    uAlpha: f32,\n};\n\n@group(0) @binding(1) var uTexture: texture_2d<f32>;\n@group(0) @binding(2) var uSampler: sampler;\n@group(1) @binding(0) var<uniform> colorOverlayUniforms : ColorOverlayUniforms;\n\n@fragment\nfn mainFragment(\n    @builtin(position) position: vec4<f32>,\n    @location(0) uv : vec2<f32>\n) -> @location(0) vec4<f32> {\n    let c = textureSample(uTexture, uSampler, uv);\n    return vec4<f32>(mix(c.rgb, colorOverlayUniforms.uColor.rgb * c.a, colorOverlayUniforms.uAlpha), c.a);\n}\n";
//#endregion
//#region node_modules/pixi-filters/lib/color-overlay/ColorOverlayFilter.mjs
...
var __publicField$24 = (obj, key, value) => {
	__defNormalProp$24(obj, typeof key !== "symbol" ? key + "" : key, value);
	return value;
};
var _ColorOverlayFilter = class _ColorOverlayFilter extends Filter {
	/** @ignore */
	constructor(...args) {
		let options = args[0] ?? {};
		if (typeof options === "number" || Array.isArray(options) || options instanceof Float32Array) {
			...
			if (args[1] !== void 0) options.alpha = args[1];
		}
		options = {
			..._ColorOverlayFilter.DEFAULT_OPTIONS,
			...options
		};
		const gpuProgram = GpuProgram.from({
			vertex: {
		...
		const glProgram = GlProgram.from({
			vertex,
			fragment: fragment$26,
			name: "color-overlay-filter"
		});
		super({
			gpuProgram,
			glProgram,
			resources: { colorOverlayUniforms: {
				uColor: {
					value: new Float32Array(3),
					type: "vec3<f32>"
				},
		...
		__publicField$24(this, "uniforms");
		__publicField$24(this, "_color");
...
__publicField$24(_ColorOverlayFilter, "DEFAULT_OPTIONS", {
...
//#endregion
//#region node_modules/pixi-filters/lib/color-replace/color-replace.mjs
var fragment$25 = "in vec2 vTextureCoord;\nout vec4 finalColor;\n\nuniform sampler2D uTexture;\nuniform vec3 uOriginalColor;\nuniform vec3 uTargetColor;\nuniform float uTolerance;\n\nvoid main(void) {\n    vec4 c = texture(uTexture, vTextureCoord);\n    vec3 colorDiff = uOriginalColor - (c.rgb / max(c.a, 0.0000000001));\n    float colorDistance = length(colorDiff);\n    float doReplace = step(colorDistance, uTolerance);\n    finalColor = vec4(mix(c.rgb, (uTargetColor + colorDiff) * c.a, doReplace), c.a);\n}\n";
//#endregion
//#region node_modules/pixi-filters/lib/color-replace/color-replace2.mjs
var source$25 = "struct ColorReplaceUniforms {\n  uOriginalColor: vec3<f32>,\n  uTargetColor: vec3<f32>,\n  uTolerance: f32,\n};\n\n@group(0) @binding(1) var uTexture: texture_2d<f32>; \n@group(0) @binding(2) var uSampler: sampler;\n@group(1) @binding(0) var<uniform> colorReplaceUniforms : ColorReplaceUniforms;\n\n@fragment\nfn mainFragment(\n   @builtin(position) position: vec4<f32>,\n    @location(0) uv : vec2<f32>\n) -> @location(0) vec4<f32> {\n  let sample: vec4<f32> = textureSample(uTexture, uSampler, uv);\n\n  let colorDiff: vec3<f32> = colorReplaceUniforms.uOriginalColor - (sample.rgb / max(sample.a, 0.0000000001));\n  let colorDistance: f32 = length(colorDiff);\n  let doReplace: f32 = step(colorDistance, colorReplaceUniforms.uTolerance);\n\n  return vec4<f32>(mix(sample.rgb, (colorReplaceUniforms.uTargetColor + colorDiff) * sample.a, doReplace), sample.a);\n}";
//#endregion
//#region node_modules/pixi-filters/lib/color-replace/ColorReplaceFilter.mjs
...
var __publicField$23 = (obj, key, value) => {
	__defNormalProp$23(obj, typeof key !== "symbol" ? key + "" : key, value);
	return value;
};
var _ColorReplaceFilter = class _ColorReplaceFilter extends Filter {
	/** @ignore */
	constructor(...args) {
		let options = args[0] ?? {};
		if (typeof options === "number" || Array.isArray(options) || options instanceof Float32Array) {
			...
			if (args[1] !== void 0) options.targetColor = args[1];
			if (args[2] !== void 0) options.tolerance = args[2];
		}
		options = {
			..._ColorReplaceFilter.DEFAULT_OPTIONS,
			...options
		};
		const gpuProgram = GpuProgram.from({
			vertex: {
		...
		super({
			gpuProgram,
			glProgram,
			resources: { colorReplaceUniforms: {
				uOriginalColor: {
					value: new Float32Array(3),
					type: "vec3<f32>"
				},
		...
		__publicField$23(this, "uniforms");
		__publicField$23(this, "_originalColor");
		__publicField$23(this, "_targetColor");
...
/** Default values for options. */
__publicField$23(_ColorReplaceFilter, "DEFAULT_OPTIONS", {
...
var __publicField$22 = (obj, key, value) => {
	__defNormalProp$22(obj, typeof key !== "symbol" ? key + "" : key, value);
	return value;
};
var _ConvolutionFilter = class _ConvolutionFilter extends Filter {
	/** @ignore */
	constructor(...args) {
		let options = args[0] ?? {};
		if (Array.isArray(options)) {
			...
			if (args[1] !== void 0) options.width = args[1];
			if (args[2] !== void 0) options.height = args[2];
		}
		options = {
			..._ConvolutionFilter.DEFAULT_OPTIONS,
			...options
		};
		...
		__publicField$22(this, "uniforms");
...
/** Default values for options. */
__publicField$22(_ConvolutionFilter, "DEFAULT_OPTIONS", {
...
//#endregion
//#region node_modules/pixi-filters/lib/cross-hatch/crosshatch.mjs
var fragment$23 = "in vec2 vTextureCoord;\nout vec4 finalColor;\n\nuniform sampler2D uTexture;\n\nvoid main(void)\n{\n    float lum = length(texture(uTexture, vTextureCoord.xy).rgb);\n\n    finalColor = vec4(1.0, 1.0, 1.0, 1.0);\n\n    if (lum < 1.00)\n    {\n        if (mod(gl_FragCoord.x + gl_FragCoord.y, 10.0) == 0.0)\n        {\n            finalColor = vec4(0.0, 0.0, 0.0, 1.0);\n        }\n    }\n\n    if (lum < 0.75)\n    {\n        if (mod(gl_FragCoord.x - gl_FragCoord.y, 10.0) == 0.0)\n        {\n            finalColor = vec4(0.0, 0.0, 0.0, 1.0);\n        }\n    }\n\n    if (lum < 0.50)\n    {\n        if (mod(gl_FragCoord.x + gl_FragCoord.y - 5.0, 10.0) == 0.0)\n        {\n            finalColor = vec4(0.0, 0.0, 0.0, 1.0);\n        }\n    }\n\n    if (lum < 0.3)\n    {\n        if (mod(gl_FragCoord.x - gl_FragCoord.y - 5.0, 10.0) == 0.0)\n        {\n            finalColor = vec4(0.0, 0.0, 0.0, 1.0);\n        }\n    }\n}\n";
//#endregion
//#region node_modules/pixi-filters/lib/cross-hatch/crosshatch2.mjs
var source$23 = "@group(0) @binding(1) var uTexture: texture_2d<f32>; \n@group(0) @binding(2) var uSampler: sampler;\n\n@fragment\nfn mainFragment(\n    @location(0) uv: vec2<f32>,\n    @builtin(position) position: vec4<f32>\n) -> @location(0) vec4<f32> {\n    let lum: f32 = length(textureSample(uTexture, uSampler, uv).rgb);\n\n    if (lum < 1.00)\n    {\n        if (modulo(position.x + position.y, 10.0) == 0.0)\n        {\n            return vec4<f32>(0.0, 0.0, 0.0, 1.0);\n        }\n    }\n\n    if (lum < 0.75)\n    {\n        if (modulo(position.x - position.y, 10.0) == 0.0)\n        {\n            return vec4<f32>(0.0, 0.0, 0.0, 1.0);\n        }\n    }\n\n    if (lum < 0.50)\n    {\n        if (modulo(position.x + position.y - 5.0, 10.0) == 0.0)\n        {\n            return vec4<f32>(0.0, 0.0, 0.0, 1.0);\n        }\n    }\n\n    if (lum < 0.3)\n    {\n        if (modulo(position.x - position.y - 5.0, 10.0) == 0.0)\n        {\n            return vec4<f32>(0.0, 0.0, 0.0, 1.0);\n        }\n    }\n\n    return vec4<f32>(1.0);\n}\n\nfn modulo(x: f32, y: f32) -> f32\n{\n  return x - y * floor(x/y);\n}";
//#endregion
//#region node_modules/pixi-filters/lib/cross-hatch/CrossHatchFilter.mjs
...
var __publicField$21 = (obj, key, value) => {
	__defNormalProp$21(obj, typeof key !== "symbol" ? key + "" : key, value);
	return value;
};
var _CRTFilter = class _CRTFilter extends Filter {
	/**
	* @param options - Options for the CRTFilter constructor.
	*/
	constructor(options) {
		options = {
			..._CRTFilter.DEFAULT_OPTIONS,
			...options
		};
		const gpuProgram = GpuProgram.from({
			vertex: {
		...
		const glProgram = GlProgram.from({
			vertex,
			fragment: fragment$22,
			name: "crt-filter"
		});
		super({
			gpuProgram,
			glProgram,
			resources: { crtUniforms: {
				uLine: {
		...
		__publicField$21(this, "uniforms");
		/**
		* A seed value to apply to the random noise generation
		* @default 0
		*/
		__publicField$21(this, "seed");
		/**
		* Opacity/intensity of the noise effect between `0` and `1`
		* @default 0.3
		*/
		__publicField$21(this, "time");
...
/** Default values for options. */
__publicField$21(_CRTFilter, "DEFAULT_OPTIONS", {
	curvature: 1,
	lineWidth: 1,
	lineContrast: .25,
	verticalLine: false,
...
//#endregion
//#region node_modules/pixi-filters/lib/dot/dot2.mjs
var fragment$21 = "precision highp float;\nin vec2 vTextureCoord;\nout vec4 finalColor;\n\nuniform sampler2D uTexture;\nuniform float uAngle;\nuniform float uScale;\nuniform bool uGrayScale;\n\nuniform vec4 uInputSize;\n\nfloat pattern()\n{\n    float s = sin(uAngle), c = cos(uAngle);\n    vec2 tex = vTextureCoord * uInputSize.xy;\n    vec2 point = vec2(\n        c * tex.x - s * tex.y,\n        s * tex.x + c * tex.y\n    ) * uScale;\n    return (sin(point.x) * sin(point.y)) * 4.0;\n    }\n\n    void main()\n    {\n    vec4 color = texture(uTexture, vTextureCoord);\n    vec3 colorRGB = vec3(color);\n\n    if (uGrayScale)\n    {\n        colorRGB = vec3(color.r + color.g + color.b) / 3.0;\n    }\n\n    finalColor = vec4(colorRGB * 10.0 - 5.0 + pattern(), color.a);\n}\n";
//#endregion
//#region node_modules/pixi-filters/lib/dot/dot.mjs
var source$21 = "struct DotUniforms {\n  uScale:f32,\n  uAngle:f32,\n  uGrayScale:f32,\n};\n\nstruct GlobalFilterUniforms {\n  uInputSize:vec4<f32>,\n  uInputPixel:vec4<f32>,\n  uInputClamp:vec4<f32>,\n  uOutputFrame:vec4<f32>,\n  uGlobalFrame:vec4<f32>,\n  uOutputTexture:vec4<f32>,\n};\n\n@group(0) @binding(0) var<uniform> gfu: GlobalFilterUniforms;\n\n@group(0) @binding(1) var uTexture: texture_2d<f32>; \n@group(0) @binding(2) var uSampler: sampler;\n@group(1) @binding(0) var<uniform> dotUniforms : DotUniforms;\n\n@fragment\nfn mainFragment(\n  @location(0) uv: vec2<f32>,\n  @builtin(position) position: vec4<f32>\n) -> @location(0) vec4<f32> {\n  let color: vec4<f32> = textureSample(uTexture, uSampler, uv);\n  let gray: vec3<f32> = vec3<f32>(dot(color.rgb, vec3<f32>(0.299, 0.587, 0.114)));\n  // dotUniforms.uGrayScale == 1 doesn't ever pass so it is converted to a float and compared to 0.5 instead \n  let finalColor: vec3<f32> = select(color.rgb, gray, f32(dotUniforms.uGrayScale) >= 0.5);\n\n  return vec4<f32>(finalColor * 10.0 - 5.0 + pattern(uv), color.a);\n}\n\nfn pattern(uv: vec2<f32>) -> f32\n{\n  let s: f32 = sin(dotUniforms.uAngle);\n  let c: f32 = cos(dotUniforms.uAngle);\n  \n  let tex: vec2<f32> = uv * gfu.uInputSize.xy;\n  \n  let p: vec2<f32> = vec2<f32>(\n      c * tex.x - s * tex.y,\n      s * tex.x + c * tex.y\n  ) * dotUniforms.uScale;\n\n  return (sin(p.x) * sin(p.y)) * 4.0;\n}";
//#endregion
//#region node_modules/pixi-filters/lib/dot/DotFilter.mjs
...
var __publicField$20 = (obj, key, value) => {
	__defNormalProp$20(obj, typeof key !== "symbol" ? key + "" : key, value);
	return value;
};
var _DotFilter = class _DotFilter extends Filter {
	/** @ignore */
	constructor(...args) {
		let options = args[0] ?? {};
		if (typeof options === "number") {
			...
			if (args[1] !== void 0) options.angle = args[1];
			if (args[2] !== void 0) options.grayscale = args[2];
		}
		options = {
			..._DotFilter.DEFAULT_OPTIONS,
			...options
		};
		const dotUniforms = {
			uScale: {
...
/** Default values for options. */
__publicField$20(_DotFilter, "DEFAULT_OPTIONS", {
	scale: 1,
	angle: 5,
	grayscale: true
});
...
//#endregion
//#region node_modules/pixi-filters/lib/drop-shadow/drop-shadow.mjs
var fragment$20 = "precision highp float;\nin vec2 vTextureCoord;\nout vec4 finalColor;\n\nuniform sampler2D uTexture;\nuniform float uAlpha;\nuniform vec3 uColor;\nuniform vec2 uOffset;\n\nuniform vec4 uInputSize;\n\nvoid main(void){\n    vec4 sample = texture(uTexture, vTextureCoord - uOffset * uInputSize.zw);\n\n    // Premultiply alpha\n    sample.rgb = uColor.rgb * sample.a;\n\n    // alpha user alpha\n    sample *= uAlpha;\n\n    finalColor = sample;\n}";
//#endregion
//#region node_modules/pixi-filters/lib/drop-shadow/drop-shadow2.mjs
var source$20 = "struct DropShadowUniforms {\n  uAlpha: f32,\n  uColor: vec3<f32>,\n  uOffset: vec2<f32>,\n};\n\nstruct GlobalFilterUniforms {\n  uInputSize:vec4<f32>,\n  uInputPixel:vec4<f32>,\n  uInputClamp:vec4<f32>,\n  uOutputFrame:vec4<f32>,\n  uGlobalFrame:vec4<f32>,\n  uOutputTexture:vec4<f32>,\n};\n\n@group(0) @binding(0) var<uniform> gfu: GlobalFilterUniforms;\n\n@group(0) @binding(1) var uTexture: texture_2d<f32>; \n@group(0) @binding(2) var uSampler: sampler;\n@group(1) @binding(0) var<uniform> dropShadowUniforms : DropShadowUniforms;\n\n@fragment\nfn mainFragment(\n  @builtin(position) position: vec4<f32>,\n  @location(0) uv : vec2<f32>\n) -> @location(0) vec4<f32> {\n  var color: vec4<f32> = textureSample(uTexture, uSampler, uv - dropShadowUniforms.uOffset * gfu.uInputSize.zw);\n\n  // Premultiply alpha\n  color = vec4<f32>(vec3<f32>(dropShadowUniforms.uColor.rgb * color.a), color.a);\n  // alpha user alpha\n  color *= dropShadowUniforms.uAlpha;\n\n  return color;\n}";
//#endregion
//#region node_modules/pixi-filters/lib/drop-shadow/DropShadowFilter.mjs
...
var _DropShadowFilter = class _DropShadowFilter extends Filter {
	/**
	* @param options - Options for the DropShadowFilter constructor.
	*/
	constructor(options) {
		options = {
			..._DropShadowFilter.DEFAULT_OPTIONS,
			...options
		};
		const gpuProgram = GpuProgram.from({
			vertex: {
		...
		* @default false
		*/
		__publicField$19(this, "shadowOnly", false);
		__publicField$19(this, "_color");
		__publicField$19(this, "_blurFilter");
		__publicField$19(this, "_basePass");
	...
	*/
	apply(filterManager, input, output, clearMode) {
		...
		if (!this.shadowOnly) filterManager.applyFilter(this._basePass, input, output, false);
		TexturePool.returnTexture(renderTarget);
	}
	/**
	...
	*/
	_updatePadding() {
		const offsetPadding = Math.max(Math.abs(this.offsetX), Math.abs(this.offsetY));
		this.padding = offsetPadding + this.blur * 2 + this.quality * 4;
	}
};
/** Default values for options. */
__publicField$19(_DropShadowFilter, "DEFAULT_OPTIONS", {
	offset: {
		x: 4,
		y: 4
	},
...
var EmbossFilter = class extends Filter {
	...
	*/
	constructor(strength = 5) {
		...
		const glProgram = GlProgram.from({
			vertex,
			fragment: fragment$19,
			name: "emboss-filter"
		});
		super({
			gpuProgram,
			glProgram,
			resources: { embossUniforms: { uStrength: {
				value: strength,
				type: "f32"
			} } }
		});
		__publicField$18(this, "uniforms");
...
var _GlitchFilter = class _GlitchFilter extends Filter {
	/**
	* @param options - Options for the GlitchFilter constructor.
	*/
	constructor(options) {
		options = {
			..._GlitchFilter.defaults,
			...options
		};
		const gpuProgram = GpuProgram.from({
			vertex: {
		...
		super({
			...
			resources: {
				glitchUniforms: {
					...
					uFillMode: {
						value: options?.fillMode ?? 0,
						type: "f32"
					},
					uOffset: {
						value: options?.offset ?? 100,
						type: "f32"
					},
					uDirection: {
		...
		__publicField$17(this, "uniforms");
		/**
		...
		*/
		__publicField$17(this, "average", false);
		/** Minimum size of slices as a portion of the `sampleSize` */
		__publicField$17(this, "minSize", 8);
		/** Height of the displacement map canvas. */
		__publicField$17(this, "sampleSize", 512);
		/** Internally generated canvas. */
		__publicField$17(this, "_canvas");
		/**
		...
		* @readonly
		*/
		__publicField$17(this, "texture");
		/** Internal number of slices */
		__publicField$17(this, "_slices", 0);
		__publicField$17(this, "_sizes", new Float32Array(1));
		__publicField$17(this, "_offsets", new Float32Array(1));
	...
	*/
	_randomizeSizes() {
		...
		const min = Math.min(this.minSize / size, .9 / this._slices);
		if (this.average) {
			const count = this._slices;
			let rest = 1;
			for (let i = 0; i < last; i++) {
				const averageWidth = rest / (count - i);
				const w = Math.max(averageWidth * (1 - Math.random() * .6), min);
				arr[i] = w;
				rest -= w;
			}
			arr[last] = rest;
	...
	*/
	_randomizeOffsets() {
		for (let i = 0; i < this._slices; i++) this._offsets[i] = Math.random() * (Math.random() < .5 ? -1 : 1);
	}
	/**
	...
	*/
	redraw() {
		...
		for (let i = 0; i < this._slices; i++) {
			...
			ctx.fillStyle = `rgba(${offset > 0 ? offset : 0}, ${offset < 0 ? -offset : 0}, 0, 1)`;
	...
	*/
	set sizes(sizes) {
		...
		for (let i = 0; i < len; i++) this._sizes[i] = sizes[i];
	}
	get sizes() {
		return this._sizes;
	}
	...
	*/
	set offsets(offsets) {
		...
		for (let i = 0; i < len; i++) this._offsets[i] = offsets[i];
	}
	get offsets() {
...
/** Default constructor options. */
__publicField$17(_GlitchFilter, "defaults", {
	slices: 5,
	offset: 100,
	direction: 0,
	fillMode: 0,
...
var _GlowFilter = class _GlowFilter extends Filter {
	...
	*/
	constructor(options) {
		...
		const glProgram = GlProgram.from({
			vertex,
			fragment: fragment$17.replace(/__ANGLE_STEP_SIZE__/gi, `${(1 / quality / distance).toFixed(7)}`).replace(/__DIST__/gi, `${distance.toFixed(0)}.0`),
			name: "glow-filter"
		});
		super({
			gpuProgram,
			...
			resources: { glowUniforms: {
				...
				uKnockout: {
					value: options?.knockout ?? false ? 1 : 0,
					type: "f32"
				}
			} },
			padding: distance
		});
		__publicField$16(this, "uniforms");
		__publicField$16(this, "_color");
...
/** Default values for options. */
__publicField$16(_GlowFilter, "DEFAULT_OPTIONS", {
	distance: 10,
	outerStrength: 4,
	innerStrength: 0,
	color: 16777215,
...
//#endregion
//#region node_modules/pixi-filters/lib/godray/perlin2.mjs
...
//#endregion
//#region node_modules/pixi-filters/lib/godray/GodrayFilter.mjs
...
var _GodrayFilter = class _GodrayFilter extends Filter {
	/**
	* @param options - Options for the GodrayFilter constructor.
	*/
	constructor(options) {
		options = {
			..._GodrayFilter.DEFAULT_OPTIONS,
			...options
		};
		const gpuProgram = GpuProgram.from({
			vertex: {
			...
			fragment: {
				source: source$16.replace("${PERLIN}", sourcePerlin),
				entryPoint: "mainFragment"
			}
		});
		const glProgram = GlProgram.from({
			vertex,
			fragment: fragment$16.replace("${PERLIN}", perlin),
			name: "god-ray-filter"
		});
		super({
			gpuProgram,
			glProgram,
			resources: { godrayUniforms: {
				uLight: {
					value: new Float32Array(2),
					type: "vec2<f32>"
				},
		...
		__publicField$15(this, "uniforms");
		/**
		* The current time position
		* @default 0
		*/
		__publicField$15(this, "time", 0);
		__publicField$15(this, "_angleLight", [0, 0]);
		__publicField$15(this, "_angle", 0);
		__publicField$15(this, "_center");
...
/** Default values for options. */
__publicField$15(_GodrayFilter, "DEFAULT_OPTIONS", {
	angle: 30,
	gain: .5,
	lacunarity: 2.5,
	parallel: true,
...
//#endregion
//#region node_modules/pixi-filters/lib/grayscale/grayscale.mjs
var fragment$15 = "in vec2 vTextureCoord;\n\nout vec4 finalColor;\n\nuniform sampler2D uTexture;\n\n// https://en.wikipedia.org/wiki/Luma_(video)\nconst vec3 weight = vec3(0.299, 0.587, 0.114);\n\nvoid main()\n{\n    vec4 c = texture(uTexture, vTextureCoord);\n    finalColor = vec4(\n        vec3(c.r * weight.r + c.g * weight.g  + c.b * weight.b),\n        c.a\n    );\n}\n";
//#endregion
//#region node_modules/pixi-filters/lib/grayscale/grayscale2.mjs
var source$15 = "@group(0) @binding(1) var uTexture: texture_2d<f32>; \n@group(0) @binding(2) var uSampler: sampler;\n\n@fragment\nfn mainFragment(\n  @location(0) uv: vec2<f32>,\n  @builtin(position) position: vec4<f32>\n) -> @location(0) vec4<f32> {\n  let color: vec4<f32> = textureSample(uTexture, uSampler, uv);\n\n  let g: f32 = dot(color.rgb, vec3<f32>(0.299, 0.587, 0.114));\n  return vec4<f32>(vec3<f32>(g), 1.);\n}";
//#endregion
//#region node_modules/pixi-filters/lib/grayscale/GrayscaleFilter.mjs
...
var _HslAdjustmentFilter = class _HslAdjustmentFilter extends Filter {
	/**
	* @param options - Options for the HslAdjustmentFilter constructor.
	*/
	constructor(options) {
		options = {
			..._HslAdjustmentFilter.DEFAULT_OPTIONS,
			...options
		};
		const gpuProgram = GpuProgram.from({
			vertex: {
...
/** Default values for options. */
__publicField$14(_HslAdjustmentFilter, "DEFAULT_OPTIONS", {
	hue: 0,
	saturation: 0,
	lightness: 0,
	colorize: false,
...
//#endregion
//#region node_modules/pixi-filters/lib/motion-blur/motion-blur.mjs
var fragment$13 = "precision highp float;\nin vec2 vTextureCoord;\nout vec4 finalColor;\n\nuniform sampler2D uTexture;\nuniform vec2 uVelocity;\nuniform int uKernelSize;\nuniform float uOffset;\n\nuniform vec4 uInputSize;\n\nconst int MAX_KERNEL_SIZE = 2048;\n\n// Notice:\n// the perfect way:\n//    int kernelSize = min(uKernelSize, MAX_KERNELSIZE);\n// BUT in real use-case , uKernelSize < MAX_KERNELSIZE almost always.\n// So use uKernelSize directly.\n\nvoid main(void)\n{\n    vec4 color = texture(uTexture, vTextureCoord);\n\n    if (uKernelSize == 0)\n    {\n        finalColor = color;\n        return;\n    }\n\n    vec2 velocity = uVelocity / uInputSize.xy;\n    float offset = -uOffset / length(uVelocity) - 0.5;\n    int k = uKernelSize - 1;\n\n    for(int i = 0; i < MAX_KERNEL_SIZE - 1; i++) {\n        if (i == k) {\n            break;\n        }\n        vec2 bias = velocity * (float(i) / float(k) + offset);\n        color += texture(uTexture, vTextureCoord + bias);\n    }\n    finalColor = color / float(uKernelSize);\n}\n";
//#endregion
//#region node_modules/pixi-filters/lib/motion-blur/motion-blur2.mjs
var source$13 = "struct MotionBlurUniforms {\n  uVelocity: vec2<f32>,\n  uKernelSize: i32,\n  uOffset: f32,\n};\n\nstruct GlobalFilterUniforms {\n  uInputSize:vec4<f32>,\n  uInputPixel:vec4<f32>,\n  uInputClamp:vec4<f32>,\n  uOutputFrame:vec4<f32>,\n  uGlobalFrame:vec4<f32>,\n  uOutputTexture:vec4<f32>,\n};\n\n@group(0) @binding(0) var<uniform> gfu: GlobalFilterUniforms;\n\n@group(0) @binding(1) var uTexture: texture_2d<f32>; \n@group(0) @binding(2) var uSampler: sampler;\n@group(1) @binding(0) var<uniform> motionBlurUniforms : MotionBlurUniforms;\n\n@fragment\nfn mainFragment(\n  @builtin(position) position: vec4<f32>,\n  @location(0) uv : vec2<f32>\n) -> @location(0) vec4<f32> {\n  let uVelocity = motionBlurUniforms.uVelocity;\n  let uKernelSize = motionBlurUniforms.uKernelSize;\n  let uOffset = motionBlurUniforms.uOffset;\n\n  let velocity: vec2<f32> = uVelocity / gfu.uInputSize.xy;\n  let offset: f32 = -uOffset / length(uVelocity) - 0.5;\n  let k: i32 = min(uKernelSize - 1, MAX_KERNEL_SIZE - 1);\n\n  var color: vec4<f32> = textureSample(uTexture, uSampler, uv);\n\n  for(var i: i32 = 0; i < k; i += 1) {\n    let bias: vec2<f32> = velocity * (f32(i) / f32(k) + offset);\n    color += textureSample(uTexture, uSampler, uv + bias);\n  }\n  \n  return select(color / f32(uKernelSize), textureSample(uTexture, uSampler, uv), uKernelSize == 0);\n}\n\nconst MAX_KERNEL_SIZE: i32 = 2048;";
//#endregion
//#region node_modules/pixi-filters/lib/motion-blur/MotionBlurFilter.mjs
...
var _MotionBlurFilter = class _MotionBlurFilter extends Filter {
	/** @ignore */
	constructor(...args) {
		let options = args[0] ?? {};
		if (Array.isArray(options) || "x" in options && "y" in options || options instanceof ObservablePoint) {
			...
			options = { velocity: {
				x: "x" in options ? options.x : options[0],
				y: "y" in options ? options.y : options[1]
			} };
			if (args[1] !== void 0) options.kernelSize = args[1];
			if (args[2] !== void 0) options.offset = args[2];
		}
		options = {
			..._MotionBlurFilter.DEFAULT_OPTIONS,
			...options
		};
		const gpuProgram = GpuProgram.from({
			vertex: {
		...
		__publicField$13(this, "_kernelSize");
...
/** Default values for options. */
__publicField$13(_MotionBlurFilter, "DEFAULT_OPTIONS", {
	velocity: {
		x: 0,
		y: 0
	},
...
//#endregion
//#region node_modules/pixi-filters/lib/multi-color-replace/multi-color-replace2.mjs
var fragment$12 = "in vec2 vTextureCoord;\nout vec4 finalColor;\n\nconst int MAX_COLORS = ${MAX_COLORS};\n\nuniform sampler2D uTexture;\nuniform vec3 uOriginalColors[MAX_COLORS];\nuniform vec3 uTargetColors[MAX_COLORS];\nuniform float uTolerance;\n\nvoid main(void)\n{\n    finalColor = texture(uTexture, vTextureCoord);\n\n    float alpha = finalColor.a;\n    if (alpha < 0.0001)\n    {\n      return;\n    }\n\n    vec3 color = finalColor.rgb / alpha;\n\n    for(int i = 0; i < MAX_COLORS; i++)\n    {\n      vec3 origColor = uOriginalColors[i];\n      if (origColor.r < 0.0)\n      {\n        break;\n      }\n      vec3 colorDiff = origColor - color;\n      if (length(colorDiff) < uTolerance)\n      {\n        vec3 targetColor = uTargetColors[i];\n        finalColor = vec4((targetColor + colorDiff) * alpha, alpha);\n        return;\n      }\n    }\n}\n";
//#endregion
//#region node_modules/pixi-filters/lib/multi-color-replace/multi-color-replace.mjs
var source$12 = "struct MultiColorReplaceUniforms {\n  uOriginalColors: array<vec3<f32>, MAX_COLORS>,\n  uTargetColors: array<vec3<f32>, MAX_COLORS>,\n  uTolerance:f32,\n};\n\n@group(0) @binding(1) var uTexture: texture_2d<f32>; \n@group(0) @binding(2) var uSampler: sampler;\n@group(1) @binding(0) var<uniform> multiColorReplaceUniforms : MultiColorReplaceUniforms;\n\n@fragment\nfn mainFragment(\n  @builtin(position) position: vec4<f32>,\n  @location(0) uv : vec2<f32>\n) -> @location(0) vec4<f32> {\n  let uOriginalColors = multiColorReplaceUniforms.uOriginalColors;\n  let uTargetColors = multiColorReplaceUniforms.uTargetColors;\n  let uTolerance = multiColorReplaceUniforms.uTolerance;\n\n  var color: vec4<f32> = textureSample(uTexture, uSampler, uv);\n\n  let alpha: f32 = color.a;\n\n  if (alpha > 0.0001)\n  {\n    var modColor: vec3<f32> = vec3<f32>(color.rgb) / alpha;\n\n    for(var i: i32 = 0; i < MAX_COLORS; i += 1)\n    {\n      let origColor: vec3<f32> = uOriginalColors[i];\n      if (origColor.r < 0.0)\n      {\n        break;\n      }\n      let colorDiff: vec3<f32> = origColor - modColor;\n      \n      if (length(colorDiff) < uTolerance)\n      {\n        let targetColor: vec3<f32> = uTargetColors[i];\n        color = vec4((targetColor + colorDiff) * alpha, alpha);\n        return color;\n      }\n    }\n  }\n\n  return color;\n}\n\nconst MAX_COLORS: i32 = ${MAX_COLORS};";
//#endregion
//#region node_modules/pixi-filters/lib/multi-color-replace/MultiColorReplaceFilter.mjs
...
var _MultiColorReplaceFilter = class _MultiColorReplaceFilter extends Filter {
	/** @ignore */
	constructor(...args) {
		let options = args[0] ?? {};
		if (Array.isArray(options)) {
		...
		options = {
			..._MultiColorReplaceFilter.DEFAULT_OPTIONS,
			...options
		};
		...
		const gpuProgram = GpuProgram.from({
			...
			fragment: {
				source: source$12.replace(/\$\{MAX_COLORS\}/g, maxColors.toFixed(0)),
				entryPoint: "mainFragment"
			}
		});
		const glProgram = GlProgram.from({
			vertex,
			fragment: fragment$12.replace(/\$\{MAX_COLORS\}/g, maxColors.toFixed(0)),
			name: "multi-color-replace-filter"
		});
		super({
			gpuProgram,
			glProgram,
			resources: { multiColorReplaceUniforms: {
				uOriginalColors: {
		...
		__publicField$12(this, "_replacements", []);
		__publicField$12(this, "_maxColors");
	...
	*/
	set replacements(replacements) {
		...
		const color = new Color();
		if (colorCount > this._maxColors) throw new Error(`Length of replacements (${colorCount}) exceeds the maximum colors length (${this._maxColors})`);
...
/** Default values for options. */
__publicField$12(_MultiColorReplaceFilter, "DEFAULT_OPTIONS", {
...
var _OldFilmFilter = class _OldFilmFilter extends Filter {
	/**
	* @param options - Options for the OldFilmFilter constructor.
	*/
	constructor(options) {
		options = {
			..._OldFilmFilter.DEFAULT_OPTIONS,
			...options
		};
		const gpuProgram = GpuProgram.from({
			vertex: {
...
/** Default values for options. */
__publicField$11(_OldFilmFilter, "DEFAULT_OPTIONS", {
	sepia: .3,
	noise: .3,
	noiseSize: 1,
	scratch: .5,
...
var _OutlineFilter = class _OutlineFilter extends Filter {
	/** @ignore */
	constructor(...args) {
		let options = args[0] ?? {};
		if (typeof options === "number") {
			...
			if (args[1] !== void 0) options.color = args[1];
			if (args[2] !== void 0) options.quality = args[2];
			if (args[3] !== void 0) options.alpha = args[3];
			if (args[4] !== void 0) options.knockout = args[4];
		}
		options = {
			..._OutlineFilter.DEFAULT_OPTIONS,
			...options
		};
		const quality = options.quality ?? .1;
		const gpuProgram = GpuProgram.from({
		...
		const glProgram = GlProgram.from({
			vertex,
			fragment: fragment$10.replace(/\$\{ANGLE_STEP\}/, _OutlineFilter.getAngleStep(quality).toFixed(7)),
			name: "outline-filter"
		});
		super({
			gpuProgram,
			...
			resources: { outlineUniforms: {
				...
				uKnockout: {
					value: options.knockout ? 1 : 0,
					type: "f32"
				}
			} }
		});
		__publicField$10(this, "uniforms");
		__publicField$10(this, "_thickness");
		__publicField$10(this, "_quality");
	...
	*/
	static getAngleStep(quality) {
		return parseFloat((Math.PI * 2 / Math.max(quality * _OutlineFilter.MAX_SAMPLES, _OutlineFilter.MIN_SAMPLES)).toFixed(7));
	}
	/**
...
/** Default values for options. */
__publicField$10(_OutlineFilter, "DEFAULT_OPTIONS", {
	thickness: 1,
	color: 0,
	alpha: 1,
	quality: .1,
...
__publicField$10(_OutlineFilter, "MIN_SAMPLES", 1);
/** The maximum number of samples for rendering outline. */
__publicField$10(_OutlineFilter, "MAX_SAMPLES", 100);
var OutlineFilter = _OutlineFilter;
//#endregion
//#region node_modules/pixi-filters/lib/pixelate/pixelate.mjs
	...
	*/
	constructor(size = 10) {
		...
		super({
			gpuProgram,
			glProgram,
			resources: { pixelateUniforms: { uSize: {
				value: new Float32Array(2),
				type: "vec2<f32>"
			} } }
		});
	...
	*/
	...
	set size(value) {
		if (value instanceof Point) {
			this.sizeX = value.x;
			this.sizeY = value.y;
		} else if (Array.isArray(value)) this.resources.pixelateUniforms.uniforms.uSize = value;
		else this.sizeX = this.sizeY = value;
	}
	/**
...
//#endregion
//#region node_modules/pixi-filters/lib/radial-blur/radial-blur2.mjs
...
var _RadialBlurFilter = class _RadialBlurFilter extends Filter {
	/** @ignore */
	constructor(...args) {
		let options = args[0] ?? {};
		if (typeof options === "number") {
		...
		options = {
			..._RadialBlurFilter.DEFAULT_OPTIONS,
			...options
		};
		const gpuProgram = GpuProgram.from({
			vertex: {
		...
		__publicField$9(this, "_angle");
		__publicField$9(this, "_kernelSize");
...
/** Default values for options. */
__publicField$9(_RadialBlurFilter, "DEFAULT_OPTIONS", {
	angle: 0,
	center: {
		x: 0,
		y: 0
...
//#endregion
//#region node_modules/pixi-filters/lib/reflection/reflection.mjs
...
var _ReflectionFilter = class _ReflectionFilter extends Filter {
	/**
	* @param options - Options for the ReflectionFilter constructor.
	*/
	constructor(options) {
		options = {
			..._ReflectionFilter.DEFAULT_OPTIONS,
			...options
		};
		const gpuProgram = GpuProgram.from({
			vertex: {
		...
		super({
			gpuProgram,
			glProgram,
			resources: { reflectionUniforms: {
				uMirror: {
					value: options.mirror ? 1 : 0,
					type: "f32"
				},
				uBoundary: {
					value: options.boundary,
					type: "f32"
				},
				uAmplitude: {
...
/** Default values for options. */
__publicField$8(_ReflectionFilter, "DEFAULT_OPTIONS", {
	mirror: true,
	boundary: .5,
	amplitude: [0, 20],
	waveLength: [30, 100],
...
//#endregion
//#region node_modules/pixi-filters/lib/rgb-split/rgb-split2.mjs
var fragment$6 = "precision highp float;\nin vec2 vTextureCoord;\nout vec4 finalColor;\n\nuniform sampler2D uTexture;\nuniform vec4 uInputSize;\nuniform vec2 uRed;\nuniform vec2 uGreen;\nuniform vec2 uBlue;\n\nvoid main(void)\n{\n   float r = texture(uTexture, vTextureCoord + uRed/uInputSize.xy).r;\n   float g = texture(uTexture, vTextureCoord + uGreen/uInputSize.xy).g;\n   float b = texture(uTexture, vTextureCoord + uBlue/uInputSize.xy).b;\n   float a = texture(uTexture, vTextureCoord).a;\n   finalColor = vec4(r, g, b, a);\n}\n";
//#endregion
//#region node_modules/pixi-filters/lib/rgb-split/rgb-split.mjs
var source$6 = "struct RgbSplitUniforms {\n    uRed: vec2<f32>,\n    uGreen: vec2<f32>,\n    uBlue: vec3<f32>,\n};\n\nstruct GlobalFilterUniforms {\n    uInputSize:vec4<f32>,\n    uInputPixel:vec4<f32>,\n    uInputClamp:vec4<f32>,\n    uOutputFrame:vec4<f32>,\n    uGlobalFrame:vec4<f32>,\n    uOutputTexture:vec4<f32>,\n};\n\n@group(0) @binding(0) var<uniform> gfu: GlobalFilterUniforms;\n\n@group(0) @binding(1) var uTexture: texture_2d<f32>; \n@group(0) @binding(2) var uSampler: sampler;\n@group(1) @binding(0) var<uniform> rgbSplitUniforms : RgbSplitUniforms;\n\n@fragment\nfn mainFragment(\n    @builtin(position) position: vec4<f32>,\n    @location(0) uv : vec2<f32>\n) -> @location(0) vec4<f32> {\n    let r = textureSample(uTexture, uSampler, uv + vec2<f32>(rgbSplitUniforms.uRed.x / gfu.uInputSize.x, rgbSplitUniforms.uRed.y / gfu.uInputSize.y)).r;\n    let g = textureSample(uTexture, uSampler, uv + vec2<f32>(rgbSplitUniforms.uGreen.x / gfu.uInputSize.x, rgbSplitUniforms.uGreen.y / gfu.uInputSize.y)).g;\n    let b = textureSample(uTexture, uSampler, uv + vec2<f32>(rgbSplitUniforms.uBlue.x / gfu.uInputSize.x, rgbSplitUniforms.uBlue.y / gfu.uInputSize.y)).b;\n    let a = textureSample(uTexture, uSampler, uv).a;\n    return vec4<f32>(r, g, b, a);\n}\n";
//#endregion
//#region node_modules/pixi-filters/lib/rgb-split/RGBSplitFilter.mjs
...
var _RGBSplitFilter = class _RGBSplitFilter extends Filter {
	/** @ignore */
	constructor(...args) {
		let options = args[0] ?? {};
		if (Array.isArray(options) || "x" in options && "y" in options) {
			...
			options = { red: options };
			if (args[1] !== void 0) options.green = args[1];
			if (args[2] !== void 0) options.blue = args[2];
		}
		options = {
			..._RGBSplitFilter.DEFAULT_OPTIONS,
			...options
		};
		const gpuProgram = GpuProgram.from({
			vertex: {
...
/** Default values for options. */
__publicField$7(_RGBSplitFilter, "DEFAULT_OPTIONS", {
	red: {
		x: -10,
		y: 0
	},
...
//#endregion
//#region node_modules/pixi-filters/lib/shockwave/shockwave2.mjs
...
//#endregion
//#region node_modules/pixi-filters/lib/shockwave/shockwave.mjs
...
//#endregion
//#region node_modules/pixi-filters/lib/shockwave/ShockwaveFilter.mjs
...
var _ShockwaveFilter = class _ShockwaveFilter extends Filter {
	/** @ignore */
	constructor(...args) {
		let options = args[0] ?? {};
		if (Array.isArray(options) || "x" in options && "y" in options) {
			...
			if (args[2] !== void 0) options.time = args[2];
		}
		options = {
			..._ShockwaveFilter.DEFAULT_OPTIONS,
			...options
		};
		const gpuProgram = GpuProgram.from({
			vertex: {
...
/** Default shockwave filter options */
__publicField$6(_ShockwaveFilter, "DEFAULT_OPTIONS", {
	/** The `x` and `y` center coordinates to change the position of the center of the circle of effect. */
	center: {
		x: 0,
		y: 0
...
//#endregion
//#region node_modules/pixi-filters/lib/simple-lightmap/simple-lightmap2.mjs
var fragment$4 = "precision highp float;\nin vec2 vTextureCoord;\nout vec4 finalColor;\n\nuniform sampler2D uTexture;\nuniform sampler2D uMapTexture;\nuniform vec3 uColor;\nuniform float uAlpha;\nuniform vec2 uDimensions;\n\nuniform vec4 uInputSize;\n\nvoid main() {\n    vec4 diffuseColor = texture(uTexture, vTextureCoord);\n    vec2 lightCoord = (vTextureCoord * uInputSize.xy) / uDimensions;\n    vec4 light = texture(uMapTexture, lightCoord);\n    vec3 ambient = uColor.rgb * uAlpha;\n    vec3 intensity = ambient + light.rgb;\n    vec3 color = diffuseColor.rgb * intensity;\n    finalColor = vec4(color, diffuseColor.a);\n}\n";
//#endregion
//#region node_modules/pixi-filters/lib/simple-lightmap/simple-lightmap.mjs
var source$4 = "struct SimpleLightmapUniforms {\n  uColor: vec3<f32>,\n  uAlpha: f32,\n  uDimensions: vec2<f32>,\n};\n\nstruct GlobalFilterUniforms {\n  uInputSize:vec4<f32>,\n  uInputPixel:vec4<f32>,\n  uInputClamp:vec4<f32>,\n  uOutputFrame:vec4<f32>,\n  uGlobalFrame:vec4<f32>,\n  uOutputTexture:vec4<f32>,\n};\n\n@group(0) @binding(0) var<uniform> gfu: GlobalFilterUniforms;\n\n@group(0) @binding(1) var uTexture: texture_2d<f32>; \n@group(0) @binding(2) var uSampler: sampler;\n@group(1) @binding(0) var<uniform> simpleLightmapUniforms : SimpleLightmapUniforms;\n@group(1) @binding(1) var uMapTexture: texture_2d<f32>;\n@group(1) @binding(2) var uMapSampler: sampler;\n\n@fragment\nfn mainFragment(\n  @builtin(position) position: vec4<f32>,\n  @location(0) uv : vec2<f32>,\n) -> @location(0) vec4<f32> {\n  let uColor = simpleLightmapUniforms.uColor;\n  let uAlpha = simpleLightmapUniforms.uAlpha;\n  let uDimensions = simpleLightmapUniforms.uDimensions;\n\n  let diffuseColor: vec4<f32> = textureSample(uTexture, uSampler, uv);\n  let lightCoord: vec2<f32> = (uv * gfu.uInputSize.xy) / simpleLightmapUniforms.uDimensions;\n  let light: vec4<f32> = textureSample(uMapTexture, uMapSampler, lightCoord);\n  let ambient: vec3<f32> = uColor * uAlpha;\n  let intensity: vec3<f32> = ambient + light.rgb;\n  let finalColor: vec3<f32> = diffuseColor.rgb * intensity;\n  return vec4<f32>(finalColor, diffuseColor.a);\n}";
//#endregion
//#region node_modules/pixi-filters/lib/simple-lightmap/SimpleLightmapFilter.mjs
...
var _SimpleLightmapFilter = class _SimpleLightmapFilter extends Filter {
	/** @ignore */
	constructor(...args) {
		let options = args[0] ?? {};
		if (options instanceof Texture) {
			...
			if (args[1] !== void 0) options.color = args[1];
			if (args[2] !== void 0) options.alpha = args[2];
		}
		options = {
			..._SimpleLightmapFilter.DEFAULT_OPTIONS,
			...options
		};
		...
		__publicField$5(this, "_color");
		__publicField$5(this, "_lightMap");
...
/** Default values for options. */
__publicField$5(_SimpleLightmapFilter, "DEFAULT_OPTIONS", {
...
//#endregion
//#region node_modules/pixi-filters/lib/simplex-noise/simplex2.mjs
...
var _SimplexNoiseFilter = class _SimplexNoiseFilter extends Filter {
	/**
	* @param options - Options for the SimplexNoise constructor.
	*/
	constructor(options) {
		options = {
			..._SimplexNoiseFilter.defaults,
			...options
		};
		const gpuProgram = GpuProgram.from({
			vertex: {
		...
		super({
			gpuProgram,
			glProgram,
			resources: { simplexUniforms: {
				uStrength: {
					value: options?.strength ?? 0,
					type: "f32"
				},
				uNoiseScale: {
					value: options?.noiseScale ?? 0,
					type: "f32"
				},
				uOffsetX: {
					value: options?.offsetX ?? 0,
					type: "f32"
				},
				uOffsetY: {
					value: options?.offsetY ?? 0,
					type: "f32"
				},
				uOffsetZ: {
					value: options?.offsetZ ?? 0,
					type: "f32"
				},
				uStep: {
					value: options?.step ?? 0,
					type: "f32"
				}
			} }
		});
...
/** Default constructor options. */
__publicField$4(_SimplexNoiseFilter, "defaults", {
	strength: .5,
	noiseScale: 10,
	offsetX: 0,
	offsetY: 0,
...
//#endregion
//#region node_modules/pixi-filters/lib/tilt-shift/tilt-shift.mjs
...
//#endregion
//#region node_modules/pixi-filters/lib/tilt-shift/tilt-shift2.mjs
...
//#endregion
//#region node_modules/pixi-filters/lib/tilt-shift/TiltShiftAxisFilter.mjs
...
var _TiltShiftAxisFilter = class _TiltShiftAxisFilter extends Filter {
	constructor(options) {
		...
		super({
			gpuProgram,
			glProgram,
			resources: { tiltShiftUniforms: {
				uBlur: {
					value: new Float32Array([options.blur, options.gradientBlur]),
					type: "vec2<f32>"
				},
				uStart: {
					value: options.start,
		...
		__publicField$3(this, "_tiltAxis");
	...
	*/
	updateDelta() {
		...
		if (this._tiltAxis === void 0) return;
...
/** Default values for options. */
__publicField$3(_TiltShiftAxisFilter, "DEFAULT_OPTIONS", {
...
//#endregion
//#region node_modules/pixi-filters/lib/tilt-shift/TiltShiftFilter.mjs
...
var TiltShiftFilter = class extends TiltShiftAxisFilter {
	...
	*/
	constructor(options) {
		...
		__publicField$2(this, "_tiltShiftYFilter");
		this._tiltShiftYFilter = new TiltShiftAxisFilter({
			...options,
			axis: "vertical"
		});
		this.updateDelta();
...
//#endregion
//#region node_modules/pixi-filters/lib/twist/twist2.mjs
var fragment$1 = "precision highp float;\nin vec2 vTextureCoord;\nout vec4 finalColor;\n\nuniform sampler2D uTexture;\nuniform vec2 uTwist;\nuniform vec2 uOffset;\nuniform vec4 uInputSize;\n\nvec2 mapCoord( vec2 coord )\n{\n    coord *= uInputSize.xy;\n    coord += uInputSize.zw;\n\n    return coord;\n}\n\nvec2 unmapCoord( vec2 coord )\n{\n    coord -= uInputSize.zw;\n    coord /= uInputSize.xy;\n\n    return coord;\n}\n\nvec2 twist(vec2 coord)\n{\n    coord -= uOffset;\n\n    float dist = length(coord);\n    float uRadius = uTwist[0];\n    float uAngle = uTwist[1];\n\n    if (dist < uRadius)\n    {\n        float ratioDist = (uRadius - dist) / uRadius;\n        float angleMod = ratioDist * ratioDist * uAngle;\n        float s = sin(angleMod);\n        float c = cos(angleMod);\n        coord = vec2(coord.x * c - coord.y * s, coord.x * s + coord.y * c);\n    }\n\n    coord += uOffset;\n\n    return coord;\n}\n\nvoid main(void)\n{\n    vec2 coord = mapCoord(vTextureCoord);\n    coord = twist(coord);\n    coord = unmapCoord(coord);\n    finalColor = texture(uTexture, coord);\n}\n";
//#endregion
//#region node_modules/pixi-filters/lib/twist/twist.mjs
...
//#endregion
//#region node_modules/pixi-filters/lib/twist/TwistFilter.mjs
...
var _TwistFilter = class _TwistFilter extends Filter {
	/**
	* @param options - Options for the TwistFilter constructor.
	*/
	constructor(options) {
		options = {
			..._TwistFilter.DEFAULT_OPTIONS,
			...options
		};
		const gpuProgram = GpuProgram.from({
			vertex: {
...
//#endregion
//#region node_modules/pixi-filters/lib/zoom-blur/zoom-blur.mjs
...
//#endregion
//#region node_modules/pixi-filters/lib/zoom-blur/zoom-blur2.mjs
...
//#endregion
//#region node_modules/pixi-filters/lib/zoom-blur/ZoomBlurFilter.mjs
...
var _ZoomBlurFilter = class _ZoomBlurFilter extends Filter {
	/**
	* @param options - Options for the ZoomBlurFilter constructor.
	*/
	constructor(options) {
		options = {
			..._ZoomBlurFilter.DEFAULT_OPTIONS,
			...options
		};
