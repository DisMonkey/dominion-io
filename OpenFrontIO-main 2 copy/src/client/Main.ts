...
import "./ui/AbilityBar";
import "./ui/DiplomacyModal";
import "./ui/DoctrineSelectionScreen";
import "./ui/EventLog";
import "./ui/EventPopup";
import "./ui/IntelPanel";
import "./ui/LeaderboardScreen";
import "./ui/LobbyScreen";
import "./ui/CampaignScreen";
import "./ui/CosmeticsScreen";
import "./ui/LeaderboardScreen";
import "./ui/LoadingScreen";
import "./ui/MainMenu";
import "./ui/NotificationSystem";
...
class Client {
  ...
  async initialize(): Promise<void> {
    ...
    const dominionFont = new FontFace(
      "DominionDisplay",
      `url(${assetUrl("fonts/overpass-bold.woff")})`,
    );
    document.fonts.add(dominionFont);
    dominionFont.load().catch(() => {});
    ...
    if (versionElements.length === 0) {
      ...
      versionElements.forEach((el) => {
        (el as HTMLElement).style.fontFamily =
          '"DominionDisplay", Inter, sans-serif';
