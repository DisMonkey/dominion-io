...
import { ActiveResearch, Tech } from "../TechTree";
...
export const MilitaryUnits = unitTypeGroup([
  UnitType.Infantry,
  UnitType.Tank,
  UnitType.Artillery,
  UnitType.Scout,
...
export interface UnitParamsMap {
  [UnitType.Infantry]: Record<string, never>;

  [UnitType.Tank]: Record<string, never>;

  [UnitType.Artillery]: Record<string, never>;

  [UnitType.Scout]: Record<string, never>;

  [UnitType.Sniper]: Record<string, never>;

  [UnitType.Medic]: Record<string, never>;

  [UnitType.Engineer]: Record<string, never>;
...
export interface Game extends GameMap {
  ...
  nearbyUnitsInto(
    out: Array<{ unit: Unit; distSquared: number }>,
    tile: TileRef,
    searchRange: number,
    types: UnitType | readonly UnitType[],
    predicate?: UnitPredicate,
