//#region node_modules/colord/plugins/lch.mjs
var r = {
	grad: .9,
	turn: 360,
	rad: 360 / (2 * Math.PI)
...
}, o = 96.422, e = 100, c = 82.521, i = function(r) {
	var t, a, u = {
...
}, f = 216 / 24389, b = 24389 / 27, d = function(r) {
	return {
		l: n(r.l, 0, 100),
		c: r.c,
	...
	}(r), n = a(t.a, 3), u = a(t.b, 3), h = Math.atan2(u, n) / Math.PI * 180;
	return {
		l: t.l,
		c: Math.sqrt(n * n + u * u),
		h: h < 0 ? h + 360 : h,
	...
	return t = {
		...
		alpha: r.a
	}, n = t.a / 500 + (a = (t.l + 16) / 116), u = a - t.b / 200, i({
	...
	var t, a, n, u;
}, x = /^lch\(\s*([+-]?\d*\.?\d+)%\s+([+-]?\d*\.?\d+)\s+([+-]?\d*\.?\d+)(deg|rad|grad|turn)?\s*(?:\/\s*([+-]?\d*\.?\d+)(%)?\s*)?\)$/i, s = function(t) {
	var a = x.exec(t);
	if (!a) return null;
	var n, u;
	return M(d({
		l: Number(a[1]),
		c: Number(a[2]),
		h: (n = a[3], u = a[4], void 0 === u && (u = "deg"), Number(n) * (r[u] || 1)),
		a: void 0 === a[5] ? 1 : Number(a[5]) / (a[6] ? 100 : 1)
	}));
};
function lch_default(r, t) {
	r.prototype.toLch = function() {
		return p(y(this.rgba));
	}, r.prototype.toLchString = function() {
		return r = p(y(this.rgba)), t = r.l, a = r.c, n = r.h, (u = r.a) < 1 ? "lch(" + t + "% " + a + " " + n + " / " + u + ")" : "lch(" + t + "% " + a + " " + n + ")";
		var r, t, a, n, u;
	}, t.string.push([s, "lch"]), t.object.push([v, "lch"]);
}
//#endregion
export { lch_default as default };

//# sourceMappingURL=colord_plugins_lch.js.map